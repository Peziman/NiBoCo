...
void Afterrun_DISP(Fstring label, int16_t value, int16_t min_val, int16_t max_val, uint8_t decimal = 0);
void Overtemp_DISP(Fstring label, int16_t value, int16_t min_val, int16_t max_val, uint8_t decimal = 0);
