...
/* OIL TEMPERATURE SENSOR ON PIN A2
...
*/
#define OIL_TABLE_SIZE 13 //Don't touch
#define OILTEMP_FILTER 10 //smooth out temperature changes lower values = faster, higher values = slower
#define ADC_NO_CONN    1000 // ADC value to detect broken sensor
#define ADC_COLD       500 // ADC value to detect cold condition
